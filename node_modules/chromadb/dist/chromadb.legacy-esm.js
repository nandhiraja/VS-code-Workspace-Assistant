...
var ApiApiFetchParamCreator = function(configuration) {
  return {
     ...
     * @throws {RequiredError}
     */
    deleteDatabaseV2(databaseName, tenant, options = {}) {
      if (databaseName === null || databaseName === void 0) {
     ...
     * @throws {RequiredError}
     */
    deleteV2(collectionId, tenant, databaseName, request, options = {}) {
      if (collectionId === null || collectionId === void 0) {
     ...
     * @throws {RequiredError}
     */
    updateV2(tenant, databaseName, collectionId, request, options = {}) {
      if (tenant === null || tenant === void 0) {
     ...
     * @throws {RequiredError}
     */
    upsertV1V1(collectionId, request, options = {}) {
      if (collectionId === null || collectionId === void 0) {
     ...
     * @throws {RequiredError}
     */
    upsertV2(tenant, databaseName, collectionId, request, options = {}) {
      if (tenant === null || tenant === void 0) {
